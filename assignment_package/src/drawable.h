...
protected:
    ...
    int m_count_transparent;     // The number of indices stored in buf_idx_transparent.
    ...
    GLuint m_buf_idx_transparent; // A Vertex Buffer Object that we will use to store triangle indices (GLuints)
    GLuint m_buf_data_transparent; // A Vertex Buffer Object that we will use to store mesh vertices (vec4s)
    ...
    bool m_idx_generated_transparent;
    bool m_data_generated_transparent;
...
public:
    ...
    void generate_idx_transparent();
    void generate_data_transparent();
    ...
    bool bind_idx_transparent();
    bool bind_data_transparent();
